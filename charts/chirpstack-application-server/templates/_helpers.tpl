...
{{/*
Return the proper chirpstack-application-server image name
*/}}
{{- define "chirpstack-application-server.image" -}}
{{ include "yggio.images.image" (dict "imageRoot" .Values.image "global" .Values.global "appVersion" .Chart.AppVersion) }}
{{- end -}}
